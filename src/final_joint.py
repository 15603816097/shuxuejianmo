...
def strict_q3(data, tasks):
    ...
    for _, t in tasks.iterrows():
        ...
        direct = _segment_cert(p,s,p_h,s_h,dem,direct_thr,(20,3,12,0),comm)
        ...
        for frac in (.25,.5,.75):
            ...
            for off in (100.,200.,300.):
                ...
                a=_segment_cert(p,rp,p_h,rh,dem,access_thr,(20,3,6,0),comm)
                b=_segment_cert(rp,s,rh,s_h,dem,back_thr,(19,8,12,0),comm)
