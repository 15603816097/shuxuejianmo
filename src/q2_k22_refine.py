"""Refine the fixed-K=22 zero-lateness Q2 solution.

Uses the proven zero-lateness K=22 model, the existing 7307.7 s incumbent as
a warm start and upper bound, and diversified CP-SAT random seeds.
"""
...
def main():
    ...
    ap.add_argument("--upper-bound",type=float,default=7307.7)
    ...
    m,cands,cmax,total_late,bm=lex.build(
        data,pool,22,"makespan",late_cap=0,hint=hint
    )
